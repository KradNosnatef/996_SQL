...
-- Thu 21 May 2020 10:50:29 PM CST
...
CREATE TABLE IF NOT EXISTS `mydb`.`Teacher` (
  ...
  INDEX `fk_Teacher_Person1_idx` (`Person_ID_Card_Number` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Student` (
  ...
  INDEX `fk_Student_Person1_idx` (`Person_ID_Card_Number` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`CourseSelection` ;
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`Student_BEFORE_UPDATE` $$
USE `mydb`$$
...
USE `mydb`$$
DROP TRIGGER IF EXISTS `mydb`.`CourseSelection_BEFORE_INSERT` $$
USE `mydb`$$
