...
public class Person implements Serializable {
    ...
    public String get_address_postal_code() {
        return address_postal_code;
    }

    public String get_address_phone_number() {
        return address_phone_number;
    }

    public void set_id_card_number(String new_id_card_number) {
        id_card_number = new_id_card_number;
    }

    public void set_card_type(boolean new_card_type) {
    ...
    public void set_gender(boolean new_gender) {
        gender = new_gender;
    }

    public void set_birthdate(String new_birthdate) {
        birthdate = new_birthdate;
    }

    public void set_nationnality(String new_nationality) {
    ...
    public void get_address_phone_number(String new_address_phone_number) {
