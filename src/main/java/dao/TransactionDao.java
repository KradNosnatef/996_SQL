...
public class TransactionDao {
    ...
    public int insertTransaction(String transactionID, String studentID, boolean type, String date,
            String originClassID, String currentClassID, String leagueMember, String reason) {
    ...
    public ArrayList<Transaction> queryTransaction(String elementSelector, int type) {
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
            if (type != -1)
                preparedStatement.setString(1, elementSelector);
            ResultSet resultSet = preparedStatement.executeQuery();
